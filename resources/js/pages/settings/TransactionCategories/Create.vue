...
const submit = async () => {
  form.post('/settings/transaction-categories', {
    onStart: () => {
    ...
    onSuccess: () => {
      success('Kategori berhasil dibuat!', {
        message: 'Kategori transaksi baru telah ditambahkan ke daftar kategori Anda.',
        duration: 5000
      });
    },
    onError: (errors) => {
      ...
      if (errors.name) {
        ...
        error('Jenis kategori diperlukan', {
          message: 'Silakan pilih jenis untuk kategori baru.',
          duration: 4000
        });
      } else {
  ...
  <FinancialAppLayout :showHeader="false" :showFab="false">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-300">
        Buat kategori baru untuk mengorganisir transaksi Anda. Kategori membantu Anda mengelompokkan transaksi berdasarkan jenisnya.
      </p>
    </div>
